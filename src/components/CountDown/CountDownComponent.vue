<template>
  <div class="h-full w-full flex justify-center items-center  ">
    <div class="absolute z-50 bg-black bg-opacity-50">
        <div class="flex">
        <div class="mx-2 md:mx-8 h-20 w-20 sm:h-99p sm:w-99p md:w-32 md:h-32  xl:h-163p xl:w-163p bg-fichas rounded-full">
            <div class="w-full h-full flex justify-center items-center">
                <p class="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-semibold neontext "
    ...
    <div class="flex ">
        <div class="mx-2 md:mx-8  w-20  sm:w-99p md:w-32  xl:w-163p text-cente text-xl md:text-3xl font-semibold  uppercase"
        :class="getIsDay?'text-black':'text-white'">Días</div>
        <div class="mx-2 md:mx-8  w-20  sm:w-99p md:w-32  xl:w-163p text-cente text-xl md:text-3xl font-semibold  uppercase"
        :class="getIsDay?'text-black':'text-white'">Horas</div>
        <div class="mx-2 md:mx-8  w-20  sm:w-99p md:w-32  xl:w-163p text-cente text-xl md:text-3xl font-semibold  uppercase"
        :class="getIsDay?'text-black':'text-white'">Minutos</div>
        <div class="hidden md:block mx-2 md:mx-8  w-20  sm:w-99p md:w-32  xl:w-163p text-cente text-xl md:text-3xl font-semibold  uppercase"
