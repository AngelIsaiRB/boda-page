<template>
  <div class="relative z-50 w-screen pastel ">
      <div class="w-full">
          ...
          <p class="dodream py-5 md:py-10 text-base md:text-xl text-red-500 text-center underline cursor-pointer">
              <a href="https://goo.gl/maps/SuXxVUAEqTSZ1mNM7">Ver en el mapa</a>
              </p>          
      </div>
  </div>
</template>
